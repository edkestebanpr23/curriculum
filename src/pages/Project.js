        ...
        <div className='container'>
            ...
            <div className=''>
                ...
                <p className='mb-4' style={{ color: color.grad[8], fontSize: 20 }}>
                    ...
                    <a href='https://play.google.com/store/apps/details?id=com.honneros.himnario&hl=en' target='_blank'> Play Store</a> {dic.himPro.t3[ilang]}
                ...
                <div className='row'>
                    <div className='col'>
                        <img src={gifHV5a} className="rounded mx-auto d-block" width={400} />
                    </div>
                    <div className='col'>
                        <img src={gifHV5b} className="rounded mx-auto d-block" width={400} />
                    </div>
                </div>
            </div>
            ...
            <div className=''>
                ...
                <div className='row'>
                    <div className='col'>
                        <img src={gifHV4a} className="rounded mx-auto d-block" width={400} />
                    </div>
                    <div className='col'>
                        <img src={gifHV4b} className="rounded mx-auto d-block" width={400} />
                    </div>
                </div>
            </div>
